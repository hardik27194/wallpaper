...
-(UICollectionView *)collectionView
{
    if(_collectionView == nil){
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, 375,  300 ) collectionViewLayout:flow];
...
-(void)reloadData
{
    ...
    self.collectionView.frame = CGRectMake(0, 0, 375, self.picturesArray.count / 2  * 150 +150 +50) ;
    }
    if(self.picturesArray.count > 10){
    self.collectionView.frame = CGRectMake(0, 0, 375, self.picturesArray.count / 2  * 150 +300 ) ; }
